const Footer: React.FC = () => (
  <footer className="my-16 text-gray-600 text-sm text-center">
    <div className="container mx-auto grid grid-cols-1 lg:grid-cols-5 gap-2">
      <a href="https://github.com/statico/jsgrids">
